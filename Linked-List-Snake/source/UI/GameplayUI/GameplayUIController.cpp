...
namespace UI
{
    namespace GameplayUI
    {
        ...
        void GameplayUIController::updateTimeComplexityText()
        {
            ...
            sf::String time_complecity_value;

            switch (time_complexity)
            {
            case TimeComplexity::NONE:
                time_complecity_value = "";
                break;
            case TimeComplexity::ONE:
                time_complecity_value = "1";
                break;
            case TimeComplexity::N:
                time_complecity_value = "N";
                break;
            }

            time_complexity_text->setText("Time Complexity : (" + time_complecity_value + ")");
